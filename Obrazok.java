...
/**
 * Túto triedu som si vypožičial z cvičení a následne ju upravil.
...
public class Obrazok {
     ...
     * @param suborSObrazkom cesta k suboru s obrazkom, ktory sa ma vykreslovat
     */
    public Obrazok(int x, String suborSObrazkom) {      
        this.obrazok = this.nacitajObrazokZoSuboru(suborSObrazkom);                                   
        this.canvas = Platno.dajPlatno2();
        this.jeViditelny = false;
        this.lavyHornyX = 100;
        this.lavyHornyY = 100; 
        this.uhol = 0;         
    ...
    /**
     * Getter na polohu obrázka (stred X).
     */
    public int getX() {
        return this.stredX;
    }
    ...
    /**
     * Getter na polohu obrázka (stred Y).
     */
    public int getY() {
        return this.stredY;
    }
    ...
    /**
     * Túto metódu som pridal, aby som v triede "Hra" pri metóde "vystrel()" vedel získať uhol natočeného obrázka.
     */
    public int getUholNatoceniaObrazku() {
        return this.uhol;
    }
    ...
    private void nakresli() {
        if (this.jeViditelny) {
            ...
            this.canvas.draw(this, this.obrazok, at);
            this.canvas.wait(10);
            //this.canvas = canvas;
        }
    }
